...
export default async function AboutUS() {
    return (
        <div className="w-full ">
            ...
            <div className='py-28 p-8 leading-relaxed '>
                        ...
                        <div className="col-md-12 col-12 bg-gray-100 p-8 rounded-lg">
                            ...
                            <ul className="flex flex-wrap gap-8">
                                <li className="flex flex-col items-center">
                                    <Image src={prodirtLogo} className="w-24 mb-2" alt="prodirt Logo" />
                                ...
                                <li className="flex flex-col items-center">
                                    <Image src={tvsLogo} className="w-24 mb-2" alt="motoFarm Logo" />
                                    <div className="text-center">Pune</div>
                                </li>
                                <li className="flex flex-col items-center">
                                    <Image src={mototriplogo} className="w-24 mb-2" alt="mototrip Logo" />
                                    <div className="text-center">Goa</div>
                                </li>
                            </ul>
                            <ul className="pl-4 mt-8 list-disc">
                                <li className="mb-2">Our Locations are the go-to places for recreational & professional Off-road activities.</li>
                                <li className="mb-2">We are experienced in track curating & building for Adventure, Motocross, 4X4 & Flat Tracks.</li>
                                <li className="mb-2">Ready to roll Flat Track Training Systems.</li>
                                <li className="mb-2">Our Facilities are Equipped with curated tracks & sufficient infrastructure to afford bike Maintenance & safe storage.</li>
                                <li className="mb-2">In-house F&B facilities for a comfortable experience</li>
                                <li className="mb-2">Well-maintained academies with camping, dorm & bio facilities.</li>
                                <li className="mb-2">Popular & Ever Growing Social Media presence in the segment.</li>
                            </ul>
